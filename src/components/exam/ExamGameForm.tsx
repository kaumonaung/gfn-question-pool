...
import ExamSubmitForm from '@/components/exam/ExamSubmitForm';
...
const ExamGameForm = ({ questions }: QuizGameFormProps) => {
  const { questionPool, updateQuestionPool, categories } = useQuestionPool();
